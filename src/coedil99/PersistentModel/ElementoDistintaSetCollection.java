...
public class ElementoDistintaSetCollection extends org.orm.util.ORMSet {
	public ElementoDistintaSetCollection(Object owner, org.orm.util.ORMAdapter adapter, int ownerKey, int targetKey, int collType) {
		super(owner, adapter, ownerKey, targetKey, true, collType);
	}
	
	public ElementoDistintaSetCollection(Object owner, org.orm.util.ORMAdapter adapter, int ownerKey, int collType) {
